...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void AddProgress(String category, int score, int wrong) {
        SQLiteDatabase db = this.getWritableDatabase();
        ContentValues values = new ContentValues();
    ...
    public Cursor getDistinctSumValues() {
        ...
        String query = " SELECT DISTINCT " + KEY_CATEGORY_QUIZ + " , SUM("+ KEY_SCORE +") FROM " + TABLE_PROGRESS + " GROUP BY " + KEY_CATEGORY_QUIZ;
        Cursor cursor = getReadableDatabase().rawQuery(query,null);
        return cursor;
    }
